(function(J, $) {
  ...
  J.Inputs.kinect = J.Class(J.Input, {
    ...
    */
    getUnderlyingJoshoverElement: function(x, y) {
      ...
      $('.joshover:visible', this.app.baseHtml).each(function(i, elt) {
        ...
        if ((offset.left <= x && (offset.left + elt.outerWidth()) >= x) && (offset.top <= y && (offset.top + elt.outerHeight()) >= y)) {
          //element, boundaries
    ...
    */
    onStationary: function() {
      ...
      pointerOffset.top += parseInt(this.cursorWidth / 2, 10);
      pointerOffset.left += parseInt(this.cursorWidth / 2, 10);
    ...
    */
    getCursorWait: function(context, bars, center, innerRadius, size, color) {
      ...
      return {
        ...
        start: function() {
          currentOffset = parseInt(bars / 2, 0);
          animating = true;
          nextAnimation(0);
        }
      };
        ...
        */
        ...
        function(stream) {
          ...
          if (oldSocket != null) {
                ...
                if (oldSocket.readyState == WS_OPEN || oldSocket.readyState == WS_CONNECTING) {
              oldSocket.close();
                }
          }
  ...
  */
  DepthJS.backend.onMessage = function(stream, data) {
    ...
    //console.log("msg",msg);
    } else if (stream == 'image') { /*DepthJS.eventHandlers.onImageMsg(data);*/
    } else if (stream == 'depth') { /*DepthJS.eventHandlers.onDepthMsg(data);*/
    }
  };
...
(function($) {
  ...
  */
  $.idleTimer = function(newTimeout, elem) {
    ...
    */
    ...
    obj.olddate = obj.olddate || (new Date()).getTime();
    ...
    if (typeof newTimeout == 'number') {
      ...
      return ((new Date()).getTime()) - obj.olddate;
    }
  ...
  */
  $.fn.idleTimer = function(newTimeout) {
    ...
    if (this[0]) $.idleTimer(newTimeout, this[0]);
