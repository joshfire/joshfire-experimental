(function(J, Ext) {
  ...
  J.UI.VideoSenchaYoutube = J.Class(J.UI.VideoBase, /** @lends J.UI.VideoPopup.prototype */ {
    ...
    */
    play: function(options) {
      ...
      this.senchaElement.update('<div class="video youtube"><iframe class="youtube-player" type="text/html" width="100%" height="100%" src="http://www.youtube.com/embed/' + options.url + '?autoplay=1" frameborder="0"></iframe></div>');
  ...
  J.UI.VideoYouTube = J.UI.VideoSenchaYoutube;
